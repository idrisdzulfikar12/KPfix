...
<body>
    ...
    <section id="inner-headline">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="pageTitle fade-in" id="headline">Struktur Organisasi</h2>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="about">                
                <div class="row"> 
                    <div class="col-md-12">
                        ...
                        <img src="https://damkar.semarangkota.go.id/assets/images/profil/struktur-organisasi/struktur-organisasi.png" alt="Struktur" class="fade-in" id="image">
                        <!-- Button Link with fade-in -->
                        <div class="text-center fade-in" id="link">
                            <a href="https://damkar.semarangkota.go.id/assets/images/profil/struktur-organisasi/struktur-organisasi.png" class="button-link">
                                Struktur Organisasi DINAS PEMADAM KEBAKARAN Kota Semarang
                            </a>
                        </div>
