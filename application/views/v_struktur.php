            ...
            <div class="about">                
                <div class="row"> 
                    <div class="col-md-12">
                        ...
                        <img src="https://dp3a.semarangkota.go.id/storage/app/media/uploaded-files/Bagan%20Struktur%20Nama%2024_001.png" alt="Struktur" class="fade-in" id="image">
                        
                        <!-- Button Link with fade-in -->
                        <div class="text-center fade-in" id="link">
                            <a href="https://dp3a.semarangkota.go.id/storage/app/media/Struktur%20Organisasi/Bagan%20Struktur%20Nama%2024.pdf" class="button-link">
                                Struktur Organisasi DP3A Kota Semarang
                            </a>
                        </div>
